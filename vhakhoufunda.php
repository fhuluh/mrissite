...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VhakhouFunda Edu Suit | M-R.i.S</title>
		...
		<div class="main-container">
			<header class="page-header" style="height:20px">
				<div class="background-image-holder parallax-background" >
					<img class="background-image" alt="Background Image" src="img/products/Capturefg.PNG">
				</div>
				...
				<div class="container" style="margin-top:-40px;">
					<div class="row">
						<div class="col-sm-12">
							...
							<h1 class="text-white">VhakhouFunda Edu Suit</h1>
							<p class="text-white lead">#You Just Got Schooled
      ...
      <section class="duplicatable-content">
    				<div class="container">
    					<div class="row">
    						...
    						<div class="col-sm-4">
    							<div class="feature">
    								<h5>Prograsive Web App</h5>
    								<p>
    								<p style="color:#000;"><b>VhakhouFunda</b> is not only developed for teacher's, this software not only gives learners to ability to assess their performance, it also gives the parents the power to get involved in their children's educational life's inside of school.
                    <br><br>
                    This suit comes in a package, there are three items in this package which web base system is one of them.
In this package, we also develop the school a website, this website will be advantageous to parents who's learners are studying at that school and also parents who are interested in enrolling their children at that school.
					<br><br>
This web  base platform
<br>
<b>What if the school already has a website?</b>
<br>
If the school already has a website, we will update the current website to have the functionality that's required to do the proper job.
    						...
    						<div class="col-sm-4">
    							<div class="feature">
    								<h5>Mobile App</h5>
    								<p>
    									  <p style="color:#000;">This is the mobile application that parents will use to have a more advance access. This is an App they download in their smart phones
                    <br><br>
                    <b><u>Activities the mobile App facilitate</u></b>
					<img src="img/slides/Screen Shot 2019-06-07 at 03.11.03.png" style="width:100%;"/>
</p>
          ...
          <section>
                      ...
                      <img src="img\products\Logo Template - RE_Logo_431.png" />
                      <p><p>
        							<p class="lead">
        								 <p style="text-align:left;"><b>VhakhouFunda Education Suit</b> is a comprehensive school management and administrative software that is developed and designed by <b>M.R.I.S</b>.
                                <br><br>
                                <b>VhakhouFunda Education Suit</b> is highly beneficial to educational institutions. Using this software you can monitor the overall working of your whole institution and have control over its day to day activities.
                                <br><br>
                                In addition, parents can also use this software to keep track of their kid's performance at school on a daily bases.
                                <br><br>

<b>VhakhouFunda</b> is a name extracted from two South African languages Isizulu and Tshivenda. It means <b>"They are learning"</b>.
			</p>
        						</div>
        					</div><!--end of row-->
        						...
        						<div class="image-gallery">
        							...
        							<div class="col-sm-8">
        								<div class="image-holder">
        									<a href="img/slides/Capturefg.PNG" data-lightbox="true"  data-title="">
        										<div class="background-image-holder">
        											<img class="background-image lightbox-image" alt="" src="img/slides/Capturefg.PNG">
        										</div>
        									</a>
        								</div>
        							</div>
        							...
        							<div class="col-sm-4">
        								<div class="image-holder" data-scroll-reveal="enter bottom and move 30px">
        									<a href="img/slides/252.PNG"data-lightbox="true" data-title="">
        										<div class="background-image-holder">
        											<img class="background-image lightbox-image" alt="" src="img/slides/252.PNG">
        										</div>
        									</a>
        								</div>
        							</div>
        							...
        							<div class="col-sm-4">
        								<div class="image-holder" data-scroll-reveal="enter bottom and move 30px">
        									<a href="img/slides/8789.PNG"data-lightbox="true" data-title="">
        										<div class="background-image-holder">
        											<img class="background-image lightbox-image" alt="" src="img/slides/8789.PNG">
        										</div>
        									</a>
        								</div>
        							</div>
        							...
        							<div class="col-sm-4">
        								<div class="image-holder" data-scroll-reveal="enter bottom and move 30px">
        									<a href="img/slides/lplp.PNG"data-lightbox="true" data-title="">
        										<div class="background-image-holder">
        											<img class="background-image lightbox-image" alt="" src="img/slides/lplp.PNG">
        										</div>
        									</a>
        								</div>
        							</div>
        							...
        							<div class="col-sm-4" data-scroll-reveal="enter bottom and move 30px">
        								<div class="image-holder">
        									<a href="img/slides/eee.png"data-lightbox="true" data-title="">
        										<div class="background-image-holder">
        											<img class="background-image lightbox-image" alt="" src="img/slides/eee.png">
        										</div>
        									</a>
        								</div>
        							</div>
      ...
      <section class="pricing-1 bg-secondary-1">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h1 class="text-white">We craft meaningful digital experiences<br>Get In touch with our consultances</h1>
              <center>
            <table style="width:50%">
            <tr>
            <th><center> <button class="btn btn-primary btn-white" onclick="openForm()"><p>Have any questions?<p></button><center>
            <br>
            ...
            <form class="formoid-metro-green" style="background-color:silver;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#000000;max-width:100%;min-width:150px" method="post"><div class="title"><h2>Lets Here from you</h2></div>
            ...
            <div class="element-textarea"><label class="title">Message</label><textarea class="small" name="textarea" cols="20" rows="5" ></textarea></div>
