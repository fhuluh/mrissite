...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Social Resposibility | M-R.i.S</title>
      ...
      <!-- /WhatsHelp.io widget -->
			...
			<header class="page-header" style="height:20px">
				...
				<div class="container" style="margin-top:-40px;">
					<div class="row">
						<div class="col-sm-12">
							<span class="text-white alt-font">What we give</span>
							<h1 class="text-white">Social Resposibility</h1>
							<p class="text-white lead">One act of kindness, that's all which is needed to
							<br>touch someone.
							<br><strong>Build</strong> a better place for all</p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							...
							<p class="lead">
Working at <strong style="color:#AA83BA">M-R.i.S</strong>, also means making a measurable difference in the world in terms of social responsibility. Our employees are encouraged to do that. It's not just a job; it's about purpose and creating meaning in the world.
<br><br>
And, with its commendable approach, there's no doubt that <strong style="color:#AA83BA">M-R.i.S</strong> is being recognized as a thought leader.
<br><br>
