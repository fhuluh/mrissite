...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Marcus Shamase | M-R.i.S</title>
		...
		<div class="main-container">
			<header class="page-header resume-header">
				<div class="background-image-holder parallax-background">
					<img class="background-image" alt="Background Image" src="img/us/IMG-3675.png">
				</div>

				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h1 class="text-white space-bottom-medium" style="font-weight:light;">Marcus Shamase</h1>
							<span>CIO</span>
			...
			<section class="duplicatable-content milestones">
                ...
                Software Engineer who can think <i>“out of the box.”<i> Strong in design
                and integration problem-solving skills. Expert in <strong>C#, .NET,
                ANGULARJS,</strong><i> and</i> <strong>T-SQL</strong> with database analysis and design.
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 text-center">
							<div class="feature feature-icon-large">
								...
								<span class="sub">GANGALEE  POWER LINE SERVICES</span>
							</div>
						</div><!--end 3 col-->
						...
						<div class="col-md-3 col-sm-6 text-center">
							<div class="feature feature-icon-large">
								...
								<div class="pin-body"></div>
								<div class="pin-head"></div>
								<h5>Oct 2013 - Dec 2013</h5>
								<span>DATA CAPTURING</span>
								<span class="sub">DEPARTMENT OF EDUCATION</span>
							</div>
						</div><!--end 3 col-->
