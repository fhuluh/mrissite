    ...
    <body>
      ...
      <div class="main-container">
                ...
                <div class="projects-container">
                						...
                						<div class="col-md-6 col-sm-12 no-pad project website image-holder">
                							<div class="background-image-holder">
                								<img class="background-image" alt="Background Image" src="img/website.PNG">
                							</div>
                							<div class="hover-state">
                								<div class="align-vertical">
                									<h1 class="text-white"><strong>Website</strong> Design / Development</h1>
                									<p class="text-white">

                									</p>
                									<a href="website_Projects.php" class="btn btn-primary btn-white">See Project</a>
                								</div>
                							</div>
                						...
                						<div class="col-md-6 col-sm-12 no-pad project development image-holder">
                							<div class="background-image-holder">
                								<img class="background-image" alt="Background Image" src="img/pos.PNG">
                							</div>
                							<div class="hover-state">
                								<div class="align-vertical">
                									<h1 class="text-white"><strong>Software / App</strong> Development</h1>

                									<a href="vhakhoufunda.php" class="btn btn-primary btn-white">See Project</a>
                								</div>
                							</div>
                						</div><!--end of individual project-->
