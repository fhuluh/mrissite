<?php $form_path='contact/formoid_files/formoid1/form.php'; require_once $form_path; ?><!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Contact Us | M-R.i.S</title>
      				...
      				<div class="container">
      					<div class="row">
      						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
      							...
      							<p class="lead">We'll love to hear from you
      							</p>
      						</div>
      					</div><!--end of row-->
