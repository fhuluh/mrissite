...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Website Portfolio | M-R.i.S</title>
    ...
    <!-- /WhatsHelp.io widget -->
				...
				<div class="container" style="margin-top:-40px;">
					<div class="row">
						<div class="col-sm-12">
							...
							<h1 class="text-white">Website Portfolio </h1>

							<br>
							<br><strong>Let Us Link You</strong> </p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
      ...
      <!-- content -->
      <div class="wrapper website_row3" style="background:#FFF;">
        <div id="container">
          <!-- ################################################################################################ -->
          <div id="homepage" class="clear">
            ...
            <section class="service"  >
                  	<ul>
                          ...
                          <!--Service 1-->
                          <li >
                          <div class="grid-half_about left">
                          <!--Large Grid-->
                      	<div class="large-grid" style="height:700px;">
                          <div class="flip-front"  style="background-color:transparent;">

                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/Bontlebame.png" alt="">
      					<div class="mask">
      					<h2 >Bontlebame</h2>
      					<p >Bontlebame was founded and launched on the 9th of August 2010...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.bontlebame.org.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/logo (3)yam.png" alt="">
      					<div class="mask">
      					<h2 >Youth Alive</h2>
      					<p >Youth Alive Ministries (YAM) is an interdenominational Christian youth...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.youthalive.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/logo-300x102 - Copy.png" alt="">
      					<div class="mask">
      					<h2 >Sephamo Dry Cleaners</h2>
      					<p >Dino Drilling is an engineering drilling company...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.dinodrilling.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/logo - VAP.png" alt="">
      					<div class="mask">
      					<h2 >V.A.P</h2>
      					<p >Good life is a South African initiative whose aim is to make personal development ...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.adellephale.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/Desktop.png" alt="">
      					<div class="mask">
      					<h2>Zvezda Game Resort</h2>
      					<p >Zvezda Game Resort is a place whereby family and friends...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.zvezdagameresort.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/ico.png" alt="">
      					<div class="mask">
      					<h2 >Nefuri Attorneys</h2>
      					<p >Nefuri Attorneys is a sole proprietary and a wholly black owned firm...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.nefuri-attorneys.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/logo (1).jpg" alt="">
      					<div class="mask">
      					<h2>Emshukantambo Secondary School</h2>
      					<p >In the eighties community leaders of Pimville-Klipspruit...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.emshukantambo.org.za" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
      					...
      					<div class="mask">
      					<h2>Bethany Combined School</h2>
      					<p >The school accomodate to children from the...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://www.bethanycombined.org.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/arise.png" alt="">
      					<div class="mask">
      					<h2>ARISE MAG</h2>
      					<p >Digital Magazine...</p>
      					<div class="social socialteam dribbble">
      						<a href="http://arisemag.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
      					<div class="teamwrap teambox">
      					<img src="img/Logos/s-2 - Copy.png" alt="">
      					<div class="mask">
      					<h2>The Christian Women in Business Network</h2>
      					<p >The Christian Women in Business Network is an interaction platform that offers...</p>
      					<div class="social socialteam dribbble">
      			<a href="https://www.christianwomenbn.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
      					</div>
      					</div>
      					</div>
                          </div>
                          ...
                          <div class="four columns">
                       <div class="teamwrap teambox">
                       <img src="img/Logos/BRA.jpg" alt="">
                       <div class="mask">
                       <h2 >BR-advisors</h2>
                       <p >We are retirement advisors/Consultants of choice, in the trade unions...</p>
                       <div class="social socialteam dribbble">
                       <a href="http://www.br-advisors.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
                       </div>
                       </div>
                       </div>
                           </div>
                          <div class="four columns">
                      <div class="teamwrap teambox">
                      <img src="img/Logos/xulu oil.png" alt="">
                      <div class="mask">
                      <h2 >Xulu oil & Gas</h2>
                      <p >We are retirement advisors/Consultants of choice, in the trade unions...</p>
                      <div class="social socialteam dribbble">
                      <a href="http://www.xuluoil.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
                      </div>
                      </div>
                      </div>
                          </div>
                          ...
                          <div class="four columns">
                <div class="teamwrap teambox">
                <img src="img/Logos/iclean1 - Copy.png" alt="">
                <div class="mask">
                <h2 >sPLASHa Dry Clean POS</h2>
                <p >sPLASHa is a point of sale, inventory management, finance management, employee management, email...</p>
                <div class="social socialteam dribbble">
                  <a href="#" class="social socialteam dribbble"target="_blank" title="Website"></a>
                </div>
                </div>
                </div>
                          </div>
                                                    ...
                                                    <div class="four columns">
                                					<div class="teamwrap teambox">
                                					<img src="img/Logos/LP Molope.png" alt="">
                                					<div class="mask">
                                					<h2 >LP Molope Attorneys</h2>
                                					<p >We are a pulsating law firm, forcusing on clients' needs ...</p>
                                					<div class="social socialteam dribbble">
                                						<a href="http://www.lpmolopeattorney.co.za/" class="social socialteam dribbble"target="_blank" title="Website"></a>
                                					</div>
                                					</div>
                                					</div>
                                                    </div>
